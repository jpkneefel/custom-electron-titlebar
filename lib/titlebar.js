...
class Titlebar extends themebar_1.Themebar {
    ...
    registerListeners() {
        this.currentWindow.on(dom_1.EventType.FOCUS, this.focus);
        this.currentWindow.on(dom_1.EventType.BLUR, this.blur);
        this.currentWindow.on(dom_1.EventType.MAXIMIZE, this.max);
        this.currentWindow.on(dom_1.EventType.UNMAXIMIZE, this.unMax);
        this.currentWindow.on(dom_1.EventType.ENTER_FULLSCREEN, this
            .enterFullscreen);
        this.currentWindow.on(dom_1.EventType.LEAVE_FULLSCREEN, this
            .leaveFullscreen);
    }
    createTitlebar() {
        // Content container
   ...
   */
    ...
    dispose() {
        ...
        // Remove listeners
        this.currentWindow.removeListener(dom_1.EventType.FOCUS, this
            .focus);
        this.currentWindow.removeListener(dom_1.EventType.BLUR, this
            .blur);
        this.currentWindow.removeListener(dom_1.EventType.MAXIMIZE, this.max);
        this.currentWindow.removeListener(dom_1.EventType.UNMAXIMIZE, this.unMax);
        this.currentWindow.removeListener(dom_1.EventType
            .ENTER_FULLSCREEN, this.enterFullscreen);
        this.currentWindow.removeListener(dom_1.EventType
            .LEAVE_FULLSCREEN, this.leaveFullscreen);
    }
}
