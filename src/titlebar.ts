...
export class Titlebar extends Themebar
{
	...
	{
		this.currentWindow.on(EventType.FOCUS, this.focus);
		this.currentWindow.on(EventType.BLUR, this.blur);
		this.currentWindow.on(EventType.MAXIMIZE, this.max);
		this.currentWindow.on(EventType.UNMAXIMIZE, this.unMax);
		this.currentWindow.on(EventType.ENTER_FULLSCREEN, this
			.enterFullscreen);
		this.currentWindow.on(EventType.LEAVE_FULLSCREEN, this
			.leaveFullscreen);
	}
   ...
   */
	...
	dispose()
	{
		...
		// Remove listeners
		this.currentWindow.removeListener(EventType.FOCUS, this
			.focus);
		this.currentWindow.removeListener(EventType.BLUR, this
			.blur);
		this.currentWindow.removeListener(EventType.MAXIMIZE
			, this.max);
		this.currentWindow.removeListener(EventType.UNMAXIMIZE
			, this.unMax);
		this.currentWindow.removeListener(EventType
